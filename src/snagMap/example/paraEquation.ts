...
export function testMap4(scene: Phaser.Scene, border: ArenaBorder): SnagMapData {
    ...
    const posCircle = (index: number) =>
        add(circleF, c(border.center.x + index * 100, border.center.y + index * 100), mul(time, c(-45)));
